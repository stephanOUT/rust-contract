...
mod set_protocol_buy_fee_percent;
pub use set_protocol_fee_percent::set_protocol_buy_fee_percent;

mod set_protocol_sell_fee_percent;
pub use set_protocol_fee_percent::set_protocol_sell_fee_percent;

mod set_subject_buy_fee_percent;
pub use set_subject_fee_percent::set_subject_buy_fee_percent;

mod set_subject_sell_fee_percent;
pub use set_subject_fee_percent::set_subject_sell_fee_percent;

mod set_referal_buy_fee_percent;
pub use set_referal_fee_percent::set_referal_buy_fee_percent;

mod set_referal_sell_fee_percent;
pub use set_referal_fee_percent::set_referal_buy_sell_percent;
